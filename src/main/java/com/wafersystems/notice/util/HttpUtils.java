...
import static com.wafersystems.notice.util.StrUtil.isNullObject;
...
/**
 * Created with Intellij IDEA. Description: Author: waferzy DateTime: 2017/2/10 13:50 Company:
 * wafersystems
 */
  ...
  public static HttpResponse doPost(String host, String path, Map<String, String> headers,
    ...
    if (bodys != null) {
      ...
      for (Map.Entry<String, String> entry : bodys.entrySet()) {
        nameValuePairList.add(new BasicNameValuePair(entry.getKey(), bodys.get(entry.getKey())));
      }
