...
public class CommonParamConstants {
  public static final String LOGO_DEFALUT = "LOGO_DEFALUT";
  public static final String URL_SMS_SERVER = "URL_SMS_SERVER";
  public static final String URL_SMS_CLIENTID = "URL_SMS_CLIENTID";
