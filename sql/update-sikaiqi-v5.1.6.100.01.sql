...
INSERT INTO `ntc_parameter` (id, param_desc, param_key, param_value) VALUES (29, '{"zh":"系统邮件重发超时时间(分钟)","en":"Email Expire(minutes)","tw":"系統郵件重發超時時間(分鐘)"}', 'DEFAULT_MAIL_EXPIRE', '10');
